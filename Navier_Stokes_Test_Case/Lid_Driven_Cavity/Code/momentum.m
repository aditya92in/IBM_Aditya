...
I_uyy(2:end-1,2:end-1)=((-U_s(2:end-1,2:end-1).*V_w(1:end-1,3:end-1)+U_n(2:end-1,2:end-1).*V_w(2:end,3:end-1)))*dx;
...
I_vxx(2:end-1,2:end-1)=(-V_w(2:end-1,2:end-1).*U_s(3:end-1,1:end-1)+V_e(2:end-1,2:end-1).*U_s(3:end-1,2:end))*dy;
