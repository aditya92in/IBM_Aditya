function [u_star,v_star]=momentum(uold,vold,dx,dy,dt,rho,mu)
%****trial 
%dx=1;dy=1;
%rho=1;mu=1;
%dt=1;
...
u_star(2:end-1,2:end-1)=(uold(2:end-1,2:end-1)-dt/(rho*dx*dy)*(I_uxx(2:end-1,2:end-1)+I_uyy(2:end-1,2:end-1))+dt/(dx*dy)*(V_uxx(2:end-1,2:end-1)+V_uyy(2:end-1,2:end-1)));
%%%%%%%%%%%%%%%%%%%%
%**************-V star%
